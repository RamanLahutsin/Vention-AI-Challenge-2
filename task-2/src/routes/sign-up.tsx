...
export const Route = createFileRoute("/sign-up")({
  ...
  head: () => ({ meta: [{ title: "Create your account — Gather" }] }),
  component: SignUp,
});
...
function SignUp() {
  ...
  async function onSubmit(e: React.FormEvent) {
    e.preventDefault();
    const parsed = formSchema.safeParse({ displayName, email, password });
    if (!parsed.success) {
    ...
    toast.success("Account created — welcome to Gather!");
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center px-4 py-16">
      ...
      <h1 className="mt-5 font-display text-4xl font-black">Create your account</h1>
      <p className="mt-2 text-center text-muted-foreground">
        Free forever for community organizers and attendees.
      </p>
